...
- [ADR-0018](0018-refine-determines-scope-via-prototype.md), [ADR-0023](0023-refine-prototype-lives-in-the-refinement-folder.md), and [ADR-0010](0010-refine-user-facing-surfaces.md) are superseded.
- [ADR-0017](0017-prototypes-live-under-agents-prototypes.md) holds for every Prototype, including one `/refine` asked for. `/refine` names `.agents/prototypes/<slug>/`.
