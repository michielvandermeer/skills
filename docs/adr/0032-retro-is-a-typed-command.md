---
status: partially superseded by ADR-0036
---
...
- The typed command stays. Auto-run and auto-apply are restored by [ADR-0036](0036-named-session-skills-apply-high-priority-retro.md).
- `/retro` looks at repo and global always-loaded agent files, as [ADR-0020](0020-retrospective-includes-global-agent-files.md) did.
