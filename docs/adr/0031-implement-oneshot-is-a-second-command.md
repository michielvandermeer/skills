...
- The Oneshot agent is Spec-bound and runs at the same effort as the Step agent, on the session's model ([ADR-0049](0049-spec-bound-agents-keep-the-session-model.md)). Leftover gaps, local-only runs, and green-against-master apply as they do to `/implement` ([ADR-0026](0026-implement-agents-close-leftover-gaps.md), [ADR-0028](0028-implement-never-leaves-the-repository.md), [ADR-0029](0029-green-is-measured-against-master.md)).
